...
improved the financial condition of enterprises. This paper uses a composite indicator as a measure
of corporate financial flexibility and treats the VAT refund policy as a quasi-natural experiment.
Using data from A-share listed companies between 2015 and 2023, this study examines the impact
of the VAT refund policy on corporate financial flexibility. The results indicate that the VAT refund
policy significantly enhances corporate financial flexibility. Mechanism tests suggest that the policy
improves financial flexibility by enhancing corporate liquidity, specifically by (1) improving cash
flow management; (2) reducing current liabilities; and (3) increasing investment and research and
development (R&D) expenditures to obtain long-term benefits, thereby enhancing financial flexibility.
Dynamic effect analysis reveals that businesses first use the refunded VAT to repay short-term debt
...
constraints, smaller sizes, and higher capital intensity.
